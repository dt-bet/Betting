...
//{
//    internal class Position : DynamicData.Binding.AbstractNotifyPropertyChanged, IDisposable, IEquatable<Position>
//    {
...
//        public Position(IGroup<Trade, string,string> trades)
//        {
//            Key = trades.Key;
...
//                .Select(query =>
//                {
//                    var buy = query.Where(trade => trade.Price>0).Sum(trade => (decimal)trade.Amount);
//                    var sell = query.Where(trade => trade.Price<0).Sum(trade => (decimal)trade.Amount);
