...
namespace Mvvm.Actions
{
    ...
    public class SetterAction : TargetedTriggerAction<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty ValueConverterProperty = DependencyProperty.Register("Value", typeof(IValueConverter), typeof(SetterAction), new PropertyMetadata(null));
        ...
        protected override void Invoke(object parameter)
        {
            ...
            {
                convertedValue = ValueConverter.Convert(parameter,null,null,null);
            }
            else
            {
